...
public class PointsPerGameGoalDiffGoalsForComparerTests
{
    private static IEnumerable Compare_variations()
    {
        ...
        yield return new TestCaseData(
            new LeagueTableRow {Team = "Norwich City", PointsPerGame     = 1, GoalDifference = 0, GoalsFor = 0, GoalAverage = 0},
            new LeagueTableRow {Team = "Newcastle United", PointsPerGame = 0, GoalDifference = 1, GoalsFor = 1, GoalAverage = 1},
            1).SetName("when points per game are different and not null");

        yield return new TestCaseData(
            new LeagueTableRow {Team = "Norwich City", PointsPerGame     = null, GoalDifference = 0, GoalsFor = 0, GoalAverage = 0},
            new LeagueTableRow {Team = "Newcastle United", PointsPerGame = 0, GoalDifference = 1, GoalsFor = 1, GoalAverage = 1},
            -1).SetName("when points per game for the first team is null");
            
        yield return new TestCaseData(
            new LeagueTableRow {Team = "Norwich City", PointsPerGame     = 0, GoalDifference = 0, GoalsFor = 0, GoalAverage = 0},
            new LeagueTableRow {Team = "Newcastle United", PointsPerGame = null, GoalDifference = 1, GoalsFor = 1, GoalAverage = 1},
        ...
        yield return new TestCaseData(
            new LeagueTableRow {Team = "Norwich City", PointsPerGame     = 0, GoalDifference = 1, GoalsFor = 0, GoalAverage = 0},
            new LeagueTableRow {Team = "Newcastle United", PointsPerGame = 0, GoalDifference = 0, GoalsFor = 1, GoalAverage = 1},
            1).SetName("when points per game are equal but goal diff is different");

        yield return new TestCaseData(
            new LeagueTableRow {Team = "Norwich City", PointsPerGame     = 0, GoalDifference = 0, GoalsFor = 1, GoalAverage = 0},
            new LeagueTableRow {Team = "Newcastle United", PointsPerGame = 0, GoalDifference = 0, GoalsFor = 0, GoalAverage = 1},
        ...
        yield return new TestCaseData(
            new LeagueTableRow {Team = "Norwich City", PointsPerGame = 0, GoalDifference = 0, GoalsFor = 0, GoalAverage = 0},
            new LeagueTableRow {Team = "Norwich City", PointsPerGame = 0, GoalDifference = 0, GoalsFor = 0, GoalAverage = 1},
